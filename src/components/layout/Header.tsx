          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-sm text-secondary-foreground/80 hover:text-secondary-foreground transition-colors uppercase tracking-wider"
              >
                {link.label}
              </a>
            ))}
            ...
            <nav className="flex flex-col items-center gap-6 py-12">
              {navLinks.map((link) => (
                <a
                  ...
                  className="font-display text-2xl text-secondary-foreground hover:text-primary transition-colors"
                >
                  {link.label}
                </a>
              ))}
