...
export const HowItWorks = () => {
  return (
    <section id="how-it-works" className="section-padding bg-secondary text-secondary-foreground">
      <div className="container-narrow">
        ...
        >
          ...
          <p className="text-lg max-w-xl mx-auto text-secondary-foreground/80">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-8 left-full w-full h-[1px] bg-secondary-foreground/20 -z-10" />
              )}
