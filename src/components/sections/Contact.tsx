        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="text-secondary-foreground/70 text-lg mb-8 leading-relaxed">
              Whether you're a tyre centre, workshop, or dealer — we'd like to hear about your business 
              and how we might work together. No pressure, no sales pitch — just a conversation.
            </p>
